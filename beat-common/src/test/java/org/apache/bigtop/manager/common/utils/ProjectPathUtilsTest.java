...
public class ProjectPathUtilsTest {
    ...
    public void testGetKeyStorePath() {
        String expectedKeyStorePath = "storeDir" + File.separator + ".beat-platform" + File.separator + "keys";
        ...
        Path storeDirPath = Paths.get("storeDir" + File.separator + ".beat-platform");
        try {
    ...
    public void testGetAgentCachePath() {
        String expectedCachePath = "storeDir" + File.separator + ".beat-platform" + File.separator + "agent-caches";
    ...
    public void testGetProjectStoreDir() {
        String storeDirPath = "userHome" + File.separator + ".beat-platform";
