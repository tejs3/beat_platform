...
public class ComponentCommandPayload {
    ...
    /**
     * CM-style process directory id, e.g. {@code 1723456789-zookeeper-zookeeper_server}.
     * When set, the agent writes configs under
     * {@code /var/run/beat-agent/process/<processId>/} and keeps prior process dirs.
     */
