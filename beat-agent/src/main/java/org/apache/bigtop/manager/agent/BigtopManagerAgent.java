...
public class BigtopManagerAgent {
    ...
    @Bean
    @Qualifier("networkIOMultiGauge") public MultiGauge networkIOMultiGauge(MeterRegistry meterRegistry) {
        return AgentHostMonitoring.newNetworkIOMultiGauge(meterRegistry);
    }
}
