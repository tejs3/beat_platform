...
public class ServiceController {
    ...
    @GetMapping("/users")
    public ResponseEntity<PageVO<ServiceUserVO>> serviceUsers(@PathVariable("clusterId") Long clusterId) {
        return ResponseEntity.success(serviceService.serviceUsers(clusterId));
    }

    @Operation(summary = "get", description = "Get a service")
    @GetMapping("/{id}")
    public ResponseEntity<ServiceVO> get(@PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id) {
        return ResponseEntity.success(serviceService.get(id));
    }

    @Operation(summary = "get by process", description = "Resolve CM-style process id to a service")
    @GetMapping("/by-process/{processId}")
    public ResponseEntity<ServiceVO> getByProcess(
            @PathVariable("clusterId") Long clusterId, @PathVariable("processId") String processId) {
        return ResponseEntity.success(serviceService.getByProcess(clusterId, processId));
    }

    @Operation(summary = "remove", description = "Remove a service")
    @DeleteMapping("/{id}")
    public ResponseEntity<Boolean> remove(@PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id) {
    ...
    public ResponseEntity<List<ServiceConfigVO>> listConf(@PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id) {
    ...
    public ResponseEntity<List<ServiceConfigVO>> updateConf(
            @PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id, @RequestBody List<ServiceConfigReq> reqs) {
    ...
    public ResponseEntity<List<ServiceConfigSnapshotVO>> listConfSnapshot(
            @PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id) {
    ...
    public ResponseEntity<ServiceConfigSnapshotVO> takeConfSnapshot(
            @PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id, @RequestBody ServiceConfigSnapshotReq req) {
    ...
    public ResponseEntity<List<ServiceConfigVO>> recoveryConfSnapshot(
            @PathVariable("clusterId") Long clusterId, @PathVariable("id") Long id, @PathVariable("snapshotId") Long snapshotId) {
