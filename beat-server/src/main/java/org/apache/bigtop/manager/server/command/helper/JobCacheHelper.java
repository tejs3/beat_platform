...
public class JobCacheHelper {
    ...
    private static Map<String, Map<String, String>> getServiceConfigMap(Long clusterId) {
        ...
        for (ServiceConfigPO serviceConfigPO : serviceConfigPOList) {
            if (serviceConfigPO.getServiceName() == null || serviceConfigPO.getServiceName().isBlank()) {
                continue;
            }
            if (serviceConfigPO.getName() == null || serviceConfigPO.getName().isBlank()) {
                continue;
            }
            ...
            if (properties != null) {
                for (Map<String, Object> property : properties) {
                    ...
                    kvMap.put(String.valueOf(property.get("name")), value == null ? "" : String.valueOf(value));
                }
            }
