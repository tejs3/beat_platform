...
public class JWTUtils {
     ...
     * <p>
     * In production, configure `beat-platform.security.jwt.secret`.
     */
    ...
    private String getSigningSecret() {
        ...
        throw new IllegalStateException(
                "JWT secret is not configured. Please set beat-platform.security.jwt.secret (or enable allowDefaultSecret for dev only).");
    }
}
