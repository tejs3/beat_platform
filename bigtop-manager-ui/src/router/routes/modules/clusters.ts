    ...
    children: [
      {
        ...
        children: [
          ...
          {
            name: 'RoleInstance',
            path: ':id/service-detail/:serviceId/role/:componentId',
            component: () => import('@/features/service-management/role-instance.vue'),
            meta: {
              hidden: true
            }
          },
          {
            // CM-style: /clusters/<clusterId>/services/<processId>/config
            name: 'ServiceConfigProcess',
            path: ':id/services/:processId/config',
            component: () => import('@/features/service-management/index.vue'),
            meta: {
              hidden: true
            }
      ...
      {
        // Old Parcels URL → combined Stacks & Parcels page
        name: 'Estates',
        path: 'estates',
        redirect: '/cluster-manage/components/list?tab=parcels',
        meta: {
          hidden: true,
          title: 'menu.estates'
        },
      ...
      },
      {
        name: 'AiAdvisory',
        path: 'ai-advisory',
        redirect: '/cluster-manage/ai-advisory/suggestions',
        meta: {
          icon: 'chatbot',
          title: 'menu.ai_advisory'
        },
        children: [
          {
            name: 'AiAdvisorySuggestions',
            path: 'suggestions',
            component: () => import('@/pages/cluster-manage/advisory/index.vue'),
            meta: {
              hidden: true,
              activeMenu: '/cluster-manage/ai-advisory/suggestions'
            }
          }
        ]
      }
