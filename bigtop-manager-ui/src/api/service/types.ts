...
export type ServiceStatusType = 1 | 2 | 3 | 4
...
export interface ServiceVO {
  ...
  metrics?: boolean
  kerberos?: boolean
  /** Full process id e.g. 1786533039-zookeeper-zookeeper_server */
  processId?: string
  /** Numeric generation for CM-style URLs */
  processGeneration?: number
  processDir?: string
  roleProcesses?: RoleProcessVO[]
}

export interface RoleProcessVO {
