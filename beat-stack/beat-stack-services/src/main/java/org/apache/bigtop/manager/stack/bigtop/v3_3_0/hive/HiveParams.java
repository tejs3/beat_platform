...
public class HiveParams extends BigtopParams {
    ...
    public Map<String, Object> hiveSite() {
        ...
        Object urisObj = configurations.get("hive.metastore.uris");
        String metastoreUris = urisObj != null ? urisObj.toString() : "thrift://localhost:9083";

        List<String> metastoreHosts = LocalSettings.componentHosts("hive_metastore");
        ...
        if (metastoreHosts != null && !metastoreHosts.isEmpty()) {
            metastoreUris = "thrift://" + metastoreHosts.get(0) + ":" + metastorePort;
            configurations.put("hive.metastore.uris", metastoreUris);
        }
        ...
        Object zkPort = zooCfg != null ? zooCfg.get("clientPort") : null;
        configurations.put("hive.zookeeper.client.port", zkPort != null ? zkPort : "2181");
        ...
        if (mysqlHosts != null && !mysqlHosts.isEmpty()) {
            String mysqlPassword = String.valueOf(LocalSettings.configurations("mysql", "common")
                    .getOrDefault("root_password", ""));
            String clusterName = LocalSettings.cluster().getName();
            configurations.put("hive.metastore.db.type", "mysql");
            configurations.put(
                    "javax.jdo.option.ConnectionURL",
                    "jdbc:mysql://" + mysqlHosts.get(0) + ":3306/" + clusterName
            ...
            configurations.putIfAbsent("hive.metastore.db.type", "postgres");
