...
(
    ...
    free_swap_space_size BIGINT,
    total_swap_space_size BIGINT,
    "desc"               VARCHAR(255)  DEFAULT NULL,
    status               INT  DEFAULT NULL,
...
VALUES
('{"apiKey": "API Key", "baseUrl": "Base URL (optional: https://api.groq.com/openai)"}','OpenAI','gpt-3.5-turbo,gpt-4,gpt-4o,gpt-3.5-turbo-16k,gpt-4-turbo-preview,gpt-4-32k,gpt-4o-mini,llama-3.1-8b-instant,llama-3.3-70b-versatile'),
