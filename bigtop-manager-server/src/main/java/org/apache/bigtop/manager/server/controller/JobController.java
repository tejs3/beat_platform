...
public class JobController {
    ...
    @GetMapping
    public ResponseEntity<PageVO<JobVO>> jobs(@PathVariable("clusterId") Long clusterId) {
        return ResponseEntity.success(jobService.jobs(clusterId));
    }

    @Operation(summary = "job details", description = "Get job details")
    @GetMapping("/{jobId}")
    public ResponseEntity<JobVO> jobDetails(@PathVariable("clusterId") Long clusterId, @PathVariable("jobId") Long jobId) {
    ...
    public ResponseEntity<PageVO<StageVO>> stages(@PathVariable("clusterId") Long clusterId, @PathVariable("jobId") Long jobId) {
    ...
    public ResponseEntity<PageVO<TaskVO>> tasks(
            @PathVariable("clusterId") Long clusterId, @PathVariable("jobId") Long jobId, @PathVariable("stageId") Long stageId) {
    ...
    public ResponseEntity<JobVO> retry(@PathVariable("clusterId") Long clusterId, @PathVariable("jobId") Long jobId) {
