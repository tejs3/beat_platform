      ...
      <template #description>
        <template v-if="hasActivePlatform">
          ...
          <div class="feature-desc">
            <a-typography-link underline @click="goAdvisory">
              {{ t('advisory.open_page') }}
            </a-typography-link>
            <a-typography-link underline @click="quickAsk(t('aiAssistant.beat_manager'))">
              {{ t('aiAssistant.beat_manager') }}
            </a-typography-link>
        ...
        <template v-else>
          ...
          <div style="margin-top: 12px">
            <a-typography-link underline @click="goAdvisory"> {{ t('advisory.open_page') }} </a-typography-link>
          </div>
        </template>
      </template>
    </a-empty>
